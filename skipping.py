...
def send_email(subject, body, recipient_emails, image_path):
    ...
    sender_password = "123"  # Replace with your app password
...
resize_factor = 0.5  # Resize factor for the frame
...
while True:
    ...
    if frame_count % 5 == 0:  # Process every 5th frame
        ...
        # Detect known faces in the resized frame using the CNN model for higher accuracy
        face_locations, face_names = sfr.detect_known_faces(small_frame, model="cnn", tolerance=0.4, unknown_threshold=0.6)
        ...
        for face_loc, name in zip(face_locations, face_names):
            ...
            if name == "Unknown":
                if last_detection != "Unknown" or unknown_timer >= 50:
                    ...
                    # Send email when unknown person is detected
                    if email_timer >= 5:  # Adjust this value for faster email notifications
                        ...
                        recipient_emails = ["123@gmail.com"]  # Add multiple recipients here
